...
const Dashboard = () => {
  ...
  // Conditional rendering if redirecting
  if (!isAuthenticated || !isAdmin()) {
    return null;
  }
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/order-details/ORD-001')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/order-details/ORD-002')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/order-details/ORD-003')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/order-details/ORD-004')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/order-details/ORD-005')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/customer-details/C001')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/customer-details/C002')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/customer-details/C003')}
                              >
                                View
                              </Button>
                            </td>
                          ...
                          <tr className="bg-white border-b">
                            ...
                            <td className="px-4 py-3">
                              <Button 
                                variant="ghost" 
                                size="sm"
                                onClick={() => router.push('/admin/customer-details/C004')}
                              >
                                View
                              </Button>
                            </td>
